...
public class Role {
 @Id public UUID id; @Column(nullable=false,unique=true,length=64) public String code; @Column(nullable=false) public String name; @Column(nullable=false,length=32) public String kind; @Column(nullable=false) public boolean active=true;
 ...
 protected Role(){} public Role(String code,String name,String kind){id=UUID.randomUUID();this.code=code;this.name=name;this.kind=kind;createdAt=updatedAt=Instant.now();}
