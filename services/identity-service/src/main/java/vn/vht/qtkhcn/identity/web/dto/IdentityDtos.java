...
public final class IdentityDtos { private IdentityDtos(){}
 ...
 public record RoleResponse(UUID id,String code,String name,String kind,String appCode,boolean active,Set<String> permissionCodes,List<MatrixEntryResponse> matrix){}
 ...
 public record BulkAssignmentRequest(@NotEmpty Set<String> roleCodes,@NotBlank String dataScope,UUID organizationId,LocalDate effectiveFrom,LocalDate effectiveTo){}
 /** Một ô ma trận theo hàng: tập quyền của `roleCode` trên chức năng đang lưu. */
 public record RoleMatrixCellRequest(@NotBlank String roleCode,Set<String> permissionCodes,Boolean enabled){}
 public record RoleMatrixFeatureRequest(@NotEmpty List<@Valid RoleMatrixCellRequest> roles){}
