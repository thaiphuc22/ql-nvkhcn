...
declare const TYPOGRAPHY_THEMES: ({ dt }: any) => string;
declare const TYPOGRAPHY_CLASSES: {
    root: string;
};
declare class UBCKTypographyStyles extends BaseStyle {
    name: string;
    classes: {
        root: string;
    };
    style: ({ dt }: any) => string;
    static ɵfac: i0.ɵɵFactoryDeclaration<UBCKTypographyStyles, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<UBCKTypographyStyles>;
}
