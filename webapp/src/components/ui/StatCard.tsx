...
export default function StatCard({ title, value, suffix, color, valueStyle, size = 'default', style, onClick }: StatCardProps) {
  return (
    <Card size={size} style={style} onClick={onClick}>
