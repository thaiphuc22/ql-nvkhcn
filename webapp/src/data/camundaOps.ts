...
export const INSTANCE_STATE: Record<
  InstanceState,
...
export const seedInstances: ProcessInstance[] = [
  {
    ...
    maNV: "RD.2026.018",
    process: "RD01.01",
    processTen: "Xét duyệt Chủ trương cấp Cơ sở",
    version: "1.2",
    buocHienTai: "Hội đồng KHCN phê duyệt",
    vaiTro: "HĐ KHCN VHT",
    batDau: "20/06/2026 09:12",
    capNhat: "27/06/2026 16:40",
    trangThai: "active",
    quaHan: false,
    hanXuLy: "05/07/2026",
  },
  {
    ...
    maNV: "RD.2026.012",
    process: "RD05.01",
    processTen: "Nghiệm thu NV KHCN cấp Cơ sở",
    version: "1.1",
    buocHienTai: "Hội đồng Nghiệm thu đánh giá",
    vaiTro: "HĐ Nghiệm thu cấp CS",
    batDau: "28/06/2026 09:00",
    capNhat: "01/07/2026 10:00",
    trangThai: "active",
    quaHan: false,
    hanXuLy: "08/07/2026",
  },
  {
    ...
    maNV: "RD.2026.025",
    process: "RD02.01",
    processTen: "Xét duyệt NV KHCN cấp Cơ sở",
    version: "1.1",
    buocHienTai: "Chuyên quản thẩm định (Đạt/Chưa đạt)",
    vaiTro: "CQ KHCN/MS/NS/TCKT",
    batDau: "24/06/2026 08:40",
    capNhat: "24/06/2026 08:41",
    trangThai: "active",
    quaHan: true,
    hanXuLy: "30/06/2026",
  },
  {
    ...
    processTen: "Xét duyệt Chủ trương cấp Cơ sở",
    version: "1.2",
    buocHienTai: "Ký duyệt cấp Trung tâm/Khối",
    vaiTro: "BGĐ TT/Khối",
    batDau: "29/06/2026 15:10",
    capNhat: "29/06/2026 15:10",
    trangThai: "active",
    quaHan: false,
    hanXuLy: "08/07/2026",
  },
  {
    instanceKey: "2251799813679220",
    maHoSo: "HS-2026-009",
    maNV: "RD.2026.009",
    process: "RD05.01",
    processTen: "Nghiệm thu NV KHCN cấp Cơ sở",
    ...
    buocHienTai: "Hội đồng Nghiệm thu đánh giá",
    vaiTro: "HĐ Nghiệm thu cấp CS",
    batDau: "10/06/2026 09:00",
    capNhat: "18/06/2026 10:30",
    trangThai: "active",
    quaHan: true,
    hanXuLy: "01/07/2026",
  },
  {
    instanceKey: "2251799813682007",
    maHoSo: "HS-2026-030",
    maNV: "RD.2026.030",
    process: "RD05.02",
    processTen: "Nghiệm thu NV KHCN cấp Tập đoàn",
    version: "1.0",
    buocHienTai: "Hội đồng Nghiệm thu Tập đoàn (có Tổ KT)",
    vaiTro: "HĐ Nghiệm thu Tập đoàn",
    batDau: "08/06/2026 09:00",
    capNhat: "22/06/2026 11:20",
    trangThai: "active",
    quaHan: false,
    hanXuLy: "04/07/2026",
  },
  {
    ...
    instanceKey: "2251799813693318",
    maHoSo: "HS-2026-033",
    maNV: "RD.2026.033",
    process: "RD03.03",
    processTen: "Tương tác PM QLKHCN ↔ SAP (chi phí)",
    version: "0.1",
    buocHienTai: "Đồng bộ dự toán sang SAP",
    vaiTro: "Job worker: sap-connector",
    batDau: "02/07/2026 14:05",
    capNhat: "02/07/2026 14:06",
    trangThai: "incident",
    quaHan: false,
    incident:
      'Job "sap:sync-budget" hết số lần thử (retries=0): SAP trả HTTP 504 (timeout). Chờ xử lý ở Operate.',
  },
  {
    instanceKey: "2251799813670044",
    maHoSo: "HS-2026-012",
    maNV: "RD.2026.012",
    process: "RD02.01",
    processTen: "Xét duyệt NV KHCN cấp Cơ sở",
    version: "1.1",
    buocHienTai: "TGĐ phê duyệt mở mới đề tài (kết thúc)",
    vaiTro: "TGĐ VHT",
    batDau: "30/05/2026 08:20",
    capNhat: "16/06/2026 10:00",
    trangThai: "completed",
    quaHan: false,
  },
  {
    // Rework: HĐXD trả lại → instance đi nhánh từ chối rồi kết thúc (OQ-002 minh hoạ).
    instanceKey: "2251799813675610",
    maHoSo: "HS-2026-021",
    maNV: "RD.2026.021",
    process: "RD01.02",
    processTen: "Xét duyệt Chủ trương cấp Tập đoàn",
    version: "1.1",
    buocHienTai: "Trả lại do Thẩm định không đạt",
    vaiTro: "CQNV VHT",
    batDau: "18/06/2026 08:00",
    capNhat: "21/06/2026 09:10",
    trangThai: "canceled",
    quaHan: false,
  },
];

/* ────────────────────── Seam B: Tích hợp (connectors) ────────────────────── */
...
export const INTEG_STATUS: Record<
  IntegStatus,
  { label: string; color: string }
> = {
...
export const seedJobRuns: JobRun[] = [
  ...
  {
    id: "j-9002",
    jobType: "plm:pull-structure",
    he: "PLM",
    maHoSo: "HS-2026-030",
    thoiDiem: "03/07/2026 07:48",
    ketQua: "retry",
    retries: 2,
    thongDiep: "Độ trễ cao 1.25s, thử lại lần 2",
  },
  {
    id: "j-9003",
    ...
    he: "QLNS",
    maHoSo: "HS-2026-018",
    thoiDiem: "03/07/2026 08:15",
    ketQua: "success",
    retries: 3,
    thongDiep: "Đồng bộ 12 nhân sự (PL1)",
  },
  {
    id: "j-9004",
    jobType: "ms:pull-contract",
    he: "MS",
    maHoSo: "HS-2026-025",
    thoiDiem: "03/07/2026 08:02",
    ketQua: "success",
    retries: 3,
    thongDiep: "Lấy 1 hợp đồng (PL4)",
  },
  {
    id: "j-9005",
    jobType: "iam:resolve-group",
    he: "IAM",
    maHoSo: "HS-2026-035",
    thoiDiem: "03/07/2026 08:20",
    ketQua: "success",
    retries: 3,
    thongDiep: "Giải nhóm HĐ Nghiệm thu (5 thành viên)",
  },
  {
    id: "j-9006",
    jobType: "ms:pull-contract",
    he: "MS",
    maHoSo: "HS-2026-027",
    thoiDiem: "02/07/2026 22:14",
    ketQua: "retry",
    retries: 1,
    thongDiep: "Lỗi mạng tạm thời, thử lại",
  },
];
