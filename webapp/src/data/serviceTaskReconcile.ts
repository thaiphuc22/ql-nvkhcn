import { curVer, seedProcesses, type ProcessDef } from './processes'
import {
...
export const SERVICE_TASK_RECONCILE_STATUS_META: Record<
  ServiceTaskReconcileStatus,
...
function activeVersionOf(
  ...
  return versions.find(
    (version) => version.serviceTaskDefinitionId === definition.id && version.status === 'ACTIVE',
  )
}
