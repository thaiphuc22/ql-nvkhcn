/**
 * Seed báo cáo Optimize cho màn Giám sát tiến trình — cycle/bottleneck/gateway/SLA,
 * DMN outcome, đề xuất cải tiến. Frontend mock; thay Optimize API khi F1.
 */
...
export interface OptimizeInsight {
  id: string
  kind: 'rut_buoc' | 'doi_sla' | 'gom_qt' | 'tach_qt'
  title: string
  detail: string
  impact: string
...
export const OPTIMIZE_CYCLE_BY_PROCESS = [
...
export const OPTIMIZE_DMN_RULE_HITS = [
...
export const INSIGHT_KIND_LABEL: Record<OptimizeInsight['kind'], string> = {
