...
export const KHCN_TEMPLATES: KhcnTemplate[] = [
  // ── Phê duyệt / ký duyệt ──────────────────────────────────────────────────
  {
    ...
    defaults: {
      name: "Ký duyệt cấp Trung tâm/Khối",
      candidateGroups: "BGD_TT",
    },
  },
  {
    id: "approve-tgd",
  ...
  // ── Thẩm định ─────────────────────────────────────────────────────────────
  {
    ...
    bpmnType: "bpmn:UserTask",
    defaults: {
      name: "Thẩm định qua Phiếu nhận xét/đánh giá",
  ...
  // ── Hội đồng (RD02/RD04/RD05) — khối tái dùng ─────────────────────────────
  {
    ...
    defaults: {
      ...
      multiInstance: {
        inputCollection: "=thanhVienHoiDong",
        inputElement: "thanhVien",
      },
    },
  },
  {
